...
import com.bangkit.lungxcan.ArticleWebviewActivity
...
class ArticleDiseaseAdapter : ListAdapter<ArticleDiseaseResponseItem, ArticleDiseaseAdapter.ListViewHolder>(DIFF_CALLBACK) {
